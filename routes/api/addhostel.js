...
/*Working: If _id is passed(in case of changing details), then on the basis availability it adds in 
...
router.post('/addhostel',(req,res)=>{
    ...
    if(req.body._id===undefined){
        ...
        if(req.body.availability==="No"){
            ...
            newHostel.save()
            .then(
                Hostel.deleteOne({_id:req.body._id})
            ...
            Hostel.updateOne({_id:req.body._id},{$set: {
                imagepath : req.body.imagepath,
                title : req.body.title,
                ownedby : req.body.ownedby,
                country :  req.body.country,
